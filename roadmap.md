...
## Vocabulary/Mistakes экран (будущий Mini App) — не скоро

Идея всплыла сама по себе в диалоге с Mrs. Smith в проде: пользователь
предложил кнопку, которая ведёт на список его ошибок и ситуаций, где
они были допущены — чтобы их можно было разобрать и они больше не
